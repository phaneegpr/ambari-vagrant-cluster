...
public class IoTConsumer
{
    public static void main(String args[])
    {
    	...
    	String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=telematicsstorageacct;AccountKey=+4+oPfBhz0uIVDyyRpxGy+OQVbUXhv9Hq61FjLT6v3hpIt1bh8WfRGIky79x0ywzlTIbTTSLP44cZ2gdxgjaig==";
        ...
        public void onEvents(PartitionContext context, Iterable<EventData> messages) throws Exception
        {
            ...
            for (EventData data : messages)
            {
                ...
                */
            	...
            	String message=new String(data.getBody(), "UTF8");
            	messageCount++;
                System.out.println("Message Count : "+messageCount);
                
                ECFGParser.parseData(message);
